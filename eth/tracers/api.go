...
func (api *API) TraceTransaction(ctx context.Context, hash common.Hash, config *TraceConfig) (interface{}, error) {
	//fmt.Println("INFO555[ 01 - TraceTransaction] hash: ", hash, ", config-Tracer: ", config.Tracer, ", config.Reexec: ", config.Reexec)
	...
	//fmt.Println("INFO555[ 01 - TraceTransaction, pre - StateAtTransaction] block: ", blockHash, ", index: ", index, ", reexec: ", reexec)
	...
	//fmt.Println("INFO555[ 01 - TraceTransaction, pre - traceTx] msg.From: ", msg.From(), ", txctx.BlockHash: ", txctx.BlockHash, ", vmctx.GetHash: ", vmctx.GetHash)
	//fmt.Println("INFO555[ 01 - TraceTransaction, pre - traceTx] msg: ", msg, " config: ", config)
...
func (api *API) TraceCall(ctx context.Context, args ethapi.TransactionArgs, blockNrOrHash rpc.BlockNumberOrHash, config *TraceCallConfig) (interface{}, error) {
	//fmt.Println("INFO555[ 03 - TraceCall] From: ", args.From, ", to: ", args.To, ", block: ", blockNrOrHash, ", Tracer: ", config.Tracer)
	//fmt.Println("INFO555[ 03 - TraceCall] config: ", config, " args: ", args)
...
func (api *API) traceTx(ctx context.Context, message core.Message, txctx *Context, vmctx vm.BlockContext, statedb *state.StateDB, config *TraceConfig) (interface{}, error) {
	//fmt.Println("INFO555[ 02 - traceTx] begin")
	var (
		tracer    Tracer
		err       error
	...
	//fmt.Println("INFO555[ 02 - traceTx] EVM is ready")
