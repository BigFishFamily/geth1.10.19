...
func newPrestateTracer(ctx *tracers.Context) tracers.Tracer {
	...
	//fmt.Println("INFO333[ 01 - newPrestateTracer!")
...
func (t *prestateTracer) CaptureStart(env *vm.EVM, from common.Address, to common.Address, create bool, input []byte, gas uint64, value *big.Int) {
	//fmt.Println("INFO333[ 02 - CaptureStart, from: ", from, ", to: ", to, ", create: ", create, ", value: ", value, ", EVM: ", env)
	t.env = env
	t.create = create
	t.to = to
...
func (t *prestateTracer) CaptureEnd(output []byte, gasUsed uint64, _ time.Duration, err error) {
	//fmt.Println("INFO333[ 03 - CaptureEnd!")
	if t.create {
...
func (t *prestateTracer) CaptureState(pc uint64, op vm.OpCode, gas, cost uint64, scope *vm.ScopeContext, rData []byte, depth int, err error) {
	...
	//fmt.Println("INFO333[ 04 - CaptureState, op: ", opText, " - ", op, ", depth: ", depth, ", pc: ", pc, ", scope: ", scope, ", gas: ", gas, ", cost: ", cost)
	*/
...
func (t *prestateTracer) CaptureTxStart(gasLimit uint64) {
	//fmt.Println("INFO333[ 05 - CaptureTxStart, gasLimit: ", gasLimit)
	t.gasLimit = gasLimit
}
...
func (t *prestateTracer) GetResult() (json.RawMessage, error) {
	//fmt.Println("INFO333[ 06 - GetResult!")
...
func (t *prestateTracer) lookupAccount(addr common.Address) {
	//fmt.Println("INFO333[ 08 - lookupAccount, address: ", addr)
...
func (t *prestateTracer) lookupStorage(addr common.Address, key common.Hash) {
	//fmt.Println("INFO333[ 09 - lookupStorage, addr: ", addr, ", key:", key)
