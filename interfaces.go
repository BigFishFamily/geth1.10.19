...
type ChainStateReader interface {
	...
	StorageByAddr(ctx context.Context, address common.Address, blockNumber *big.Int) ([]map[string]common.Hash, error)
	AccountInfo(ctx context.Context, address common.Address, blockNumber *big.Int) (accInfo *types.StateAccount, err error)
	StorageByAddrKeyAndNumber(ctx context.Context, address common.Address, blockNumber *big.Int, startKey common.Hash, number int) ([]map[string]common.Hash, error)
	BlockAccountInfo222(ctx context.Context, blockNumber *big.Int) (map[common.Hash]common.AccInfo, error)
	StorageAt222(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error)
	CodeText(ctx context.Context, account common.Address, blockNumber *big.Int) (string, error)
