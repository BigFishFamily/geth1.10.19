...
func (ec *Client) StorageAt222(ctx context.Context, account common.Address, key common.Hash, blockNumber *big.Int) ([]byte, error) {
	var result hexutil.Bytes
	err := ec.c.CallContext(ctx, &result, "eth_getStorageAt222", account, key, toBlockNumArg(blockNumber))
	return result, err
}

//return State key-value data of an address
func (ec *Client) StorageByAddr(ctx context.Context, account common.Address, blockNumber *big.Int) ([]map[string]common.Hash, error) {
	var result = make([]map[string]common.Hash, 0)
	err := ec.c.CallContext(ctx, &result, "eth_getStorageByAddr", account, toBlockNumArg(blockNumber))
	return result, err
}

//return Account information (balance, nonce, codehash and state root)
func (ec *Client) AccountInfo(ctx context.Context, account common.Address, blockNumber *big.Int) (*types.StateAccount, error) {
	var result *types.StateAccount
	err := ec.c.CallContext(ctx, &result, "eth_getAccountInfo", account, toBlockNumArg(blockNumber))
	return result, err
}

//return part of storage key-value data
func (ec *Client) StorageByAddrKeyAndNumber(ctx context.Context, account common.Address, blockNumber *big.Int, startKey common.Hash, number int) ([]map[string]common.Hash, error) {
	var result = make([]map[string]common.Hash, 0)
	err := ec.c.CallContext(ctx, &result, "eth_getStorageByAddrKeyAndNumber", account, toBlockNumArg(blockNumber), startKey, number)
	return result, err
}

//return part of storage key-value data
func (ec *Client) BlockAccountInfo222(ctx context.Context, blockNumber *big.Int) (map[common.Hash]common.AccInfo, error) {
	var result map[common.Hash]common.AccInfo
	err := ec.c.CallContext(ctx, &result, "eth_getBlockAccountInfo222", toBlockNumArg(blockNumber))
	return result, err
}

func (ec *Client) CodeText(ctx context.Context, account common.Address, blockNumber *big.Int) (string, error) {
	var result string
	err := ec.c.CallContext(ctx, &result, "eth_getCodeText", account, toBlockNumArg(blockNumber))
	return result, err
}
