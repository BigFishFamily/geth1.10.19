...
func (t *SecureTrie) TryGet222(key []byte) ([]byte, error) {
	fmt.Println("INFO [SecureTrie->TryGet222, hashKey(Bytes2Hex):", common.Bytes2Hex(t.hashKey(key)), ", hashkey(BytesToHash): ", common.BytesToHash(t.hashKey(key)), "]")

	return t.trie.TryGet222(t.hashKey(key))
}
