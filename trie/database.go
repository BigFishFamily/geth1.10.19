...
func (db *Database) preimage(hash common.Hash) []byte {
	...
	//**************************************************************************//
	//Add this for debug by Junling on 08/08/2022
	fmt.Println("INFO [", time.Now(), "][Trie->GetKey,]-[key:", hash, "] NOT found from Trie cache and preimages, will read data from DB on disk")
	//**************************************************************************//
